...
<html>
  <head>
    ...
    <title><?= $tab_title ?> eBarangay </title>
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a class="logo">
          ...
          <span class="logo-lg"><b>e</b>Barangay</span>
        </a>
              ...
              <li class="dropdown user user-menu">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-footer">
                    <div class="pull-left">
                      <a href="<?= base_url("index.php/profile?id=").$this->session->userdata('id')?>" class="btn btn-default btn-flat">Profile</a>
                    </div>
      ...
      <footer class="main-footer">
        ...
        <!-- Default to the left -->
        eBarangay Inventory Tracking System &copy; 2016
      </footer>
